...
This section provides an overview of the data used in the analysis, covering the period 2020--2023 for approximately 100 unique European banks in the EBA dataset. It presents descriptive statistics for the main variables of interest, examines their correlations, and illustrates their distributions and trends over time.

## Summary Statistics

Table \@ref(tab:summary-stats) provides summary statistics for the key variables in our analysis, including overall ESG scores, ESG pillar scores (environmental, social, governance), and various banking risk and control measures (e.g., capital ratios, leverage, provisions, liquidity, and equity ratios). 
