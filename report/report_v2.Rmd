...
# Source the R script with your functions
source(here::here("R", "import_ESG.R"))
source(here::here("R", "import_financial.R"))
source(here::here("R", "merging_ESG_financial.R"))
source(here::here("R", "analysis2.R"))
