...
This section provides an overview of the data used in the analysis, covering the period 2020-2023 for approximately 100 unique Eurozone banks.

### Summary Statistics

Table \@ref(tab:summary-stats) presents the summary statistics for the key variables used in our models, including ESG scores, banking risk indicators, and control variables.
...
# Optional: Save the table for external use (e.g., if compiling LaTeX separately)
# save_kable(summary_table, "tables/table_summary_stats.tex")

```

### Correlations

Table \@ref(tab:correlation-matrix) shows the Pearson correlation coefficients between the main variables. This helps understand the linear associations present in the data.
...
# save_kable(correlation_table, "tables/table_correlation.tex")
```

### Variable Distributions

Figure \@ref(fig:distributions) illustrates the distributions of selected key variables using histograms and density plots.
...
# ggsave("figures/figure_distributions.png", plot = distribution_plot, width = 8, height = 6, dpi = 300)
```

### Time Trends (Optional)

Figure \@ref(fig:time-trends) shows the average trend of selected variables over the sample period (2020-2023).
...
# Optional: Save the plot
# ggsave("figures/figure_time_trends.png", plot = time_trend_plot, width = 9, height = 4, dpi = 300)
```
